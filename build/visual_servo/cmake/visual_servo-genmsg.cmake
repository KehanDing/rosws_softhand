...
message(STATUS "visual_servo: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ivisual_servo:/home/zhenruichen/rosws_softhand/src/visual_servo/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/zhenruichen/rosws_softhand/src/visual_servo/msg/object_position.msg" NAME_WE)
add_custom_target(_visual_servo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "visual_servo" "/home/zhenruichen/rosws_softhand/src/visual_servo/msg/object_position.msg" ""
)
...
_generate_msg_cpp(visual_servo
  "/home/zhenruichen/rosws_softhand/src/visual_servo/msg/object_position.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/visual_servo)
  install(CODE "execute_process(COMMAND \"/home/zhenruichen/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/visual_servo\")")
  # install generated code
  install(
