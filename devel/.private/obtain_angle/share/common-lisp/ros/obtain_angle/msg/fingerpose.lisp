...
(cl:in-package obtain_angle-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <fingerpose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'fingerpose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obtain_angle-msg:<fingerpose> is deprecated: use obtain_angle-msg:fingerpose instead.")))

(cl:ensure-generic-function 'origin_Q_tag1-val :lambda-list '(m))
(cl:defmethod origin_Q_tag1-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:origin_Q_tag1-val is deprecated.  Use obtain_angle-msg:origin_Q_tag1 instead.")
  (origin_Q_tag1 m))

(cl:ensure-generic-function 'origin_Q_tag2-val :lambda-list '(m))
(cl:defmethod origin_Q_tag2-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:origin_Q_tag2-val is deprecated.  Use obtain_angle-msg:origin_Q_tag2 instead.")
  (origin_Q_tag2 m))

(cl:ensure-generic-function 'origin_Q_tag3-val :lambda-list '(m))
(cl:defmethod origin_Q_tag3-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:origin_Q_tag3-val is deprecated.  Use obtain_angle-msg:origin_Q_tag3 instead.")
  (origin_Q_tag3 m))

(cl:ensure-generic-function 'YAW_DIP-val :lambda-list '(m))
(cl:defmethod YAW_DIP-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:YAW_DIP-val is deprecated.  Use obtain_angle-msg:YAW_DIP instead.")
  (YAW_DIP m))

(cl:ensure-generic-function 'TRANS_DIP-val :lambda-list '(m))
(cl:defmethod TRANS_DIP-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:TRANS_DIP-val is deprecated.  Use obtain_angle-msg:TRANS_DIP instead.")
  (TRANS_DIP m))

(cl:ensure-generic-function 'YAW_PIP-val :lambda-list '(m))
(cl:defmethod YAW_PIP-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:YAW_PIP-val is deprecated.  Use obtain_angle-msg:YAW_PIP instead.")
  (YAW_PIP m))

(cl:ensure-generic-function 'TRANS_PIP-val :lambda-list '(m))
(cl:defmethod TRANS_PIP-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:TRANS_PIP-val is deprecated.  Use obtain_angle-msg:TRANS_PIP instead.")
  (TRANS_PIP m))

(cl:ensure-generic-function 'YAW_MCP-val :lambda-list '(m))
(cl:defmethod YAW_MCP-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:YAW_MCP-val is deprecated.  Use obtain_angle-msg:YAW_MCP instead.")
  (YAW_MCP m))

(cl:ensure-generic-function 'TRANS_MCP-val :lambda-list '(m))
(cl:defmethod TRANS_MCP-val ((m <fingerpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obtain_angle-msg:TRANS_MCP-val is deprecated.  Use obtain_angle-msg:TRANS_MCP instead.")
  (TRANS_MCP m))
